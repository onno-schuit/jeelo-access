<?php
  ...
  $string['modulename'] = "Toegang leerlingen";
  $string['modulenameplural'] = 'Toegang leerlingen';
  ...
  $string['newmodulename'] = 'Toegang leerlingen';
  ...
  $string['newmodule'] = 'Toegang leerlingen';
